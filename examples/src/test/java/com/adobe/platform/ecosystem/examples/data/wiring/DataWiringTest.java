...
public class DataWiringTest extends BaseTest{

    DataWiring dataWiring = null;
    ...
    public void testConstructorWithHttpClient() {
        assertTrue(dataWiring!=null);
    }

    @Test
    public void testGetDataReaderFactory() {
        assertTrue(dataWiring.dataReaderFactory()!=null);
    }

    @Test
    public void testGetDataWriterFactory() {
        assertTrue(dataWiring.dataWriterFactory()!=null);
    }
