...
public class ParquetIOReaderImplTest {
    ...
    public void testGetSchema() throws URISyntaxException, ParquetIOException, IOException {
        ...
        Assert.assertEquals(fields.get(1).getSubFields().size(),9);
        ...
        Assert.assertEquals(fields.get(1).getSubFields().get(3).getName(),"latitude");
        Assert.assertEquals(fields.get(1).getSubFields().get(3).getType(),ParquetIODataType.DOUBLE);
        Assert.assertEquals(fields.get(1).getSubFields().get(4).getName(),"byteKey");
        Assert.assertEquals(fields.get(1).getSubFields().get(4).getType(),ParquetIODataType.BYTE);
        Assert.assertEquals(fields.get(1).getSubFields().get(5).getName(),"longKey");
        Assert.assertEquals(fields.get(1).getSubFields().get(5).getType(),ParquetIODataType.LONG);
        Assert.assertEquals(fields.get(1).getSubFields().get(6).getName(),"binaryKey");
        Assert.assertEquals(fields.get(1).getSubFields().get(6).getType(),ParquetIODataType.BINARY);
        Assert.assertEquals(fields.get(1).getSubFields().get(7).getName(),"longitude");
        Assert.assertEquals(fields.get(1).getSubFields().get(7).getType(),ParquetIODataType.FLOAT);
        Assert.assertEquals(fields.get(1).getSubFields().get(8).getName(),"tags");
        Assert.assertEquals(fields.get(1).getSubFields().get(8).getType(),ParquetIODataType.STRING);
        Assert.assertEquals(fields.get(1).getSubFields().get(8).getRepetitionType(),ParquetIORepetitionType.REPEATED);
